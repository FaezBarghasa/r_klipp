//! Implementation for the TMC2208 stepper motor driver.
//! The TMC2208 is register-compatible with the TMC2209 for many basic features.
...
/// Represents the slave address of the TMC2208.
#[derive(Clone, Copy)]
...
/// Register addresses for the TMC2208.
#[repr(u8)]
enum Register {
    GCONF = 0x00,
    IOIN = 0x06,
...
/// Driver for the TMC2208.
pub struct Tmc2208<SERIAL> {
    serial: SERIAL,
    slave_addr: u8,
}

impl<SERIAL, E> Tmc2208<SERIAL>
where
    SERIAL: Write<u8, Error = E>,
{
    /// Creates a new TMC2208 driver instance.
